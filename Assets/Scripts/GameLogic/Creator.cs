...
public class Creator : MonoBehaviour
{
    ...
    [SerializeField] private List<ActiveItem> _bonusItems;
    ...
    private void CreateItemInTube()
    {
        ...
        if (_ballsLeft % 10 == 0)
        {
            int randomNumber = Random.Range(0, _bonusItems.Count);
            _itemInTube = Instantiate(_bonusItems[randomNumber], _tube.position, Quaternion.identity);
        }
        else
        {
